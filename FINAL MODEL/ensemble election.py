...
prediction_elmo = [1 if ps >0.5 else 0 for ps in post_save_preds]

# print(prediction)
# In[ ]:

mse = mean_squared_error(test_labela, prediction_elmo)
print('Mean Squared Error = ' + str(mse))

roc_auc = roc_auc_score(test_labela, prediction_elmo)
...
text_post1 = data['Tweets'].tolist()
# text_des1 = data['description'].tolist()
label = data['Task A'].tolist()
...
prediction_bert = [1 if ps >0.5 else 0 for ps in post_save_preds]
# print(prediction)
# In[ ]:

mse = mean_squared_error(test_labels_post, prediction_bert)
print('Mean Squared Error = ' + str(mse))

roc_auc = roc_auc_score(test_labels_post, prediction_bert)
print('ROC_AUC Report = ' +str(roc_auc))
...
prediction_wt = (prediction_elmo+prediction_bert)/2
prediction_wt = [1 if i>=0.5 else 0 i for i in prediction_wt]


# In[ ]:


mse = mean_squared_error(test_labels_post, prediction_wt)
print('Mean Squared Error = ' + str(mse))

roc_auc = roc_auc_score(test_labels_post, prediction_wt)
print('ROC_AUC Report = ' +str(roc_auc))

rep = classification_report(test_labels_post, prediction_wt, digits=4)
print('Classification Report \n' +str(rep))
