...
train_inputs = train_inputs.reshape(864,370*3)
test_inputs = test_inputs.reshape(217,370*3)
print(test_inputs.shape)
print(train_inputs.shape)
...
classifier.fit(train_inputs,train_labels_post,validation_split=0.2,callbacks=[es])
