...
def build_model(max_seq_length_post, max_seq_length_des):
    ...
    dense = tf.keras.layers.Dense(100, activation='relu')(cat_output)
    pred = tf.keras.layers.Dense(1, activation='sigmoid')(dense)

    model = tf.keras.models.Model(inputs=[bert_inputs_post, bert_inputs_des], outputs=pred)
    print('Model Loaded')
    return model
...
train_inputs = [train_input_ids_post, train_input_masks_post, train_segment_ids_post, train_input_ids_des, train_input_masks_des, train_segment_ids_des]
test_inputs = [test_input_ids_post, test_input_masks_post, test_segment_ids_post, test_input_ids_des, test_input_masks_des, test_segment_ids_des]
